...
#ifdef ex14
// Efetue a leitura de dez elementos para o vetor A. Construa o vetor B,
// observando a seguinte lei de formação: se o valor do índice do vetor for par,
// o valor do elemento deve ser multiplicado pelo valor 5; sendo o índice ímpar,
...
int main() {
  ...
  forzao(10) { vetB[i] = i % 2 == 0 ? vetA[i] * 5 : vetA[i] + 5; }
